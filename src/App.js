    ...
    <div className="container mt-3">
      <div className="row d-flex justify-content-center">
        <div className="col-md-4 col-lg-8 ">
          <h1 className='bg-dark text-center text-light '>Fetched Data</h1>
          ...
          {users.length > 0 && (
            <ul className="list-group">
              {users.map((user) => (
                <li
                  key={user.id}
                  className={`list-group-item mb-2 d-flex justify-content-center bg-secondary bg-opacity-50 text-white ${
